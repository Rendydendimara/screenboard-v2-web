...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const getErrorMsg = useMemo(() => {
    // Ambil semua pesan error dari formik
    return Object.values(formik.errors);
  }, [formik.errors]);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md !rounded-[32px] !gap-6">
        <DialogHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-8 rounded-[8px] !text-body-4 pt-[5px]  pl-8 "
                />
              </div>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                className="h-8 rounded-[8px] pl-8 !text-body-4 pt-[5px]"
              />
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="***********"
                  required
                  className="h-8 rounded-[8px] pl-8 !text-body-4"
                />
              </div>
              {mode === "login" && (
        ...
        <div className={clsx("flex flex-col items-center gap-3 !mt-6")}>
          <Button
            type="submit"
            className="font-bold bg-gradient-to-r from-blue-500 to-purple-600 text-white border-0 px-4 py-3 h-11 w-full rounded-2xl text-sm lg:text-base"
          ...
          >
            ...
            {mode === "login" ? "Sign In using Google" : "Sign Up using Google"}
          </Button>
        </div>
